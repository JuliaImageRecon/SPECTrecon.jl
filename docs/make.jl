...
format = Documenter.HTML(;
    prettyurls = isci,
    edit_link = "main",
    canonical = "https://JeffFessler.github.io/SPECTrecon.jl/stable/",
#   assets = String[],
)
...
if isci
    deploydocs(;
        repo = "github.com/JeffFessler/SPECTrecon.jl",
        devbranch = "main",
        devurl = "dev",
        versions = ["stable" => "v^", "dev" => "dev"],
        forcepush = true,
        push_preview = true,
        # see https://JeffFessler.github.io/SPECTrecon.jl/previews/PR##
    )
else
